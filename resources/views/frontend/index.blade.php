     ...
     <div class="owl-carousel sidebar-carousel custom-carousel owl-theme outer-top-ss">
      <div class="item">
       <div class="products">
        ...
        <div class="text-left product-info m-t-20">
    ...
    <div class="sidebar-widget product-tag wow fadeInUp">
     ...
     <div class="sidebar-widget-body outer-top-xs">
      <div class="tag-list"> <a class="item" title="Phone" href="category.html">Phone</a> <a class="item active"
        ...
        href="category.html">Smartphone</a> <a class="item" title="Furniture" href="category.html">Furniture</a> <a
        class="item" title="T-shirt" href="category.html">T-shirt</a> <a class="item" title="Sweatpants"
    ...
    <div class="sidebar-widget wow fadeInUp outer-top-vs ">
     <div id="advertisement" class="advertisement">
      ...
      <div class="item">
       ...
       <div class="testimonials"><em>"</em>Vtae sodales aliq uam morbi non sem lacus port mollis. Nunc condime tum metus
        eud molest sed consectetuer.<em>"</em></div>
      ...
      <div class="item" style="background-image: url({{ asset('frontend/assets/images/sliders/01.jpg')}});">
       <div class="container-fluid">
        <div class="text-left caption bg-color vertical-center">
         ...
         <div class="excerpt fadeInDown-2 hidden-xs"> <span>Lorem ipsum dolor sit amet, consectetur adipisicing
           elit.</span> </div>
      ...
      <div class="item" style="background-image: url(frontend/assets/images/sliders/02.jpg);">
       <div class="container-fluid">
        <div class="text-left caption bg-color vertical-center">
         ...
         <div class="excerpt fadeInDown-2 hidden-xs"> <span>Nemo enim ipsam voluptatem quia voluptas sit aspernatur aut
           odit aut fugit</span> </div>
         <div class="button-holder fadeInDown-3"> <a href="index.php?page=single-product"
           class="btn-lg btn btn-uppercase btn-primary shop-now-button">Shop Now</a> </div>
        </div>
        <!-- /.caption -->
