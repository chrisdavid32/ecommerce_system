 ...
 <head>
  ...
  <title>Chrisdavid Ecommerce System - Log in </title>
      ...
      <div class="col-lg-4 col-md-5 col-12">
       ...
       <div class="p-30 rounded30 box-shadowed b-2 b-dashed">
        <form method="POST" action="{{ isset($guard) ? url($guard.'/login') : route('login') }}">
         ...
         <div class="form-group">
          <div class="mb-3 input-group">
           ...
           <input type="email" class="text-white bg-transparent form-control pl-15 plc-white" id="email" name="email" placeholder="Email">
          </div>
         </div>
         <div class="form-group">
          <div class="mb-3 input-group">
           ...
           <input type="password" id="password" class="text-white bg-transparent form-control pl-15 plc-white" name="password" placeholder="Password">
          </div>
         </div>
         <div class="row">
          <div class="col-6">
        ...
        <div class="text-center">
         <p class="mb-0 text-white mt-15">Don't have an account? <a href="auth_register.html"
           class="ml-5 text-info">Sign Up</a></p>
        </div>
       </div>
      </div>
     </div>
